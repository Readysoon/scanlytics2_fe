					...
					<div class="medicalResultBarselectedList">
						...
						{#if items.name == "Findings"}
							{#each items.questions as question (question)}
								...
								style="border: {selectedArr.includes(question?.id) ? '1px solid grey' : 'none'};
		...
		{#if resultAreaToggle}
			...
			{/each}
			  ...
			  <div class="medicalQuestionArea">
				...
				<div class="medicalQuestionTitle">
					Scanned Questions
			   </div>
			   ...
			   <div class="medicalQuestionList">
				   ...
				   {#if items.name == "Findings" }
					   {#each items.questions as question (question)}
						   {#if loadArrtracker.includes(question?.id)}
						   <div class="medicalQuestionItem" on:click={() => handleSelectedQuestion(question?.id)}>
		   ...
		   {/each}
			   ...
			   <div class="startConversationArea"
